            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <div
                    ...
                    <div class="flex justify-between items-center sm:justify-start gap-4 w-full">
                        <h1 class="md:text-lg sm:text-md text-sm font-semibold text-contrast whitespace-nowrap leading-loose">
                            <?= $heading ?>
                        </h1>
                        <a class="font-semibold bg-transparent hover:bg-red-600/60 hover:text-white shadow text-red-600/60 my-auto px-2 rounded md:text-3xl sm:text-2xl text-3xl"
                            data-tooltip-target="add-student" data-tooltip-placement="right" href="/add/student">
                            +
                        </a>
                        <div id="add-student" role="tooltip"
                            ...
                            <tbody>
                                ...
                                if (sizeOf($students) > 0) {
                                    foreach ($students as $student) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-b border-b-black text-nowrap font-semibold text-left">
                                                <?= $student['firstname'] ?>
                                            </td>
                                            <td class="border-b border-b-black text-nowrap font-semibold text-left">
                                                <?= $student['middlename'] ?>
                                            ...
                                            <td class="border-b border-b-black text-nowrap text-center">
                                                <?= $student['studentId'] ?>
                                            </td>
                                            <td class="border-b border-b-black text-nowrap text-center">
                                                <?= $student['email'] ?>
                                            ...
                                            <td class="border-b border-b-black text-nowrap text-center <?= ($yearStay == $yearsCanStay) ? "text-red-600 font-medium" : "text-contrast" ?>">
                                                <?= "{$yearStay} Years" ?>
                                            </td>
                                            <td class="border-b border-b-black text-nowrap text-center <?= ($yearStay == $yearShouldStay) ? "text-contrast" : "text-red-600 font-medium"?>">
                                                <?= ($yearStay == $yearShouldStay) ? "Reqular" : "Irregular"?>
                                            </td>
                                            <td class="border-b py-2 border-b-black">
                                                <div class="text-center py-2">
                                                    <a id="tooltipButton<?= $count ?>" type="button" data-tooltip-target="show-students" data-tooltip-placement="left" href="/students/<?= $student['studentId'] ?>"
                                ...
                                <?php } else { ?>
                                    <tr class="font-semibold uppercase bg-gray-200 text-contrast">
                                        ...
                                        <td class="hidden"></td>
                                        <td class="hidden"></td>
                                        <td colspan="11" class="p-1 px-9">No data recorded yet</td>
                                        <td class="hidden"></td>
                                        <td class="hidden"></td>
                                        <td class="hidden"></td>
                                        <td class="hidden"></td>
