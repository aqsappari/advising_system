        ...
        <div class="w-form p-5 pr-7 bg-white shadow rounded-b mx-auto">
            <div class="px-4 pb-4">
                <a href="<?= $_SESSION['location'] ?? '/' ?>" data-tooltip-target="go-back"
                    ...
                    class="my-auto px-2 me-2 text-2xl font-medium text-white focus:outline-none rounded shadow bg-purple-300 focus:z-10 focus:ring-4 focus:ring-purple-300">
                    < </a>
            ...
            <form method="post" action="/action/add" class="w-full">
                ...
                <div class="border border-gray-100 shadow rounded my-3 mx-1 p-5 relative w-full">
                    <span
                        class="absolute border border-gray-100 shadow rounded top-0 -translate-y-3 left-2 bg-white px-1 text-blue-600">Personal
                        Information:
                    </span>
                ...
                <p class="px-2"><span class="font-medium">NOTE: </span> The username is in the format - Fi.Lastname
                    (i.e. <span class="text-red-400">ju.delacruz</span>).</p>
                <p class="px-2 mb-3"><span class="font-medium">NOTE: </span> The default password is the the Faculty's
                    contact number.</p>
