            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <div
                    ...
                    <div class="flex justify-between sm:justify-start gap-4 w-full">
                        ...
                        <a class="font-semibold bg-red-600/60 hover:bg-red-300/80 hover:text-red-600/60 shadow text-white my-auto px-2 rounded text-3xl flex items-center gap-2"
                            data-tooltip-target="add-faculty" data-tooltip-placement="right" href="/add/faculty">
                            + <span class="hidden sm:block text-lg font-bold">Add Faculty</span>
                        </a>
                        <div id="add-faculty" role="tooltip"
                            class="absolute z-10 invisible sm:hidden inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            Add Faculty
                        </div>
                    </div>
