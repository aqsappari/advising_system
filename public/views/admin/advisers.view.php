            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                ...
                <div class="p-3 flex gap-3 overflow-x-hidden">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <a id="tooltipButton<?= $count ?>"
                                                        href="/advisers/<?= $adviser['employeeId'] ?>"
                    ...
                    <div class="dataTable min-w-full w-full">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores consectetur aliquid earum enim
                        quis quod distinctio tempore aliquam nesciunt molestias laborum, fuga qui expedita quo dolores
                        aspernatur nulla at officiis.
                    </div>
                </div>
            </div>
