...
$router->get("/add/convert", "public/views/adviser/convert.php");

$router->post('/bulk-add-students', 'public/views/adviser/bulk-add-students.php');

$router->post("/action/add-student", "controllers/adviser/process_add_student.php");
...
$router->post("/request/getSemesterSubjects", "controllers/action/request/getSemesterSubjects.php");
$router->post("/request/getAvailableSubjects", "controllers/action/request/getAvailableSubjects.php");
$router->get("/request/getAvailableSubjects", "controllers/action/request/getAvailableSubjects.php");
$router->get("/request/readGEC", "controllers/action/request/readGEC.php");
$router->post("/request/deleteGEC", "controllers/action/request/deleteGEC.php");
$router->post("/request/editGEC", "controllers/action/request/editGEC.php");
$router->post("/request/uploadGEC", "controllers/action/request/uploadGEC.php");
//Request <-- ENDS HERE -->




$router->get("/create/new/database", "migrate/index.php");
